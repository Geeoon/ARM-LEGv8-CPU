...
The following files were authored by Scott Hauck: `src/rtl/math.sv`, `src/rtl/memory/datamem.sv`, `src/rtl/memory/instructmem.sv`, `src/rtl/regfile/D_FF.sv`, `src/binaries/*`.
